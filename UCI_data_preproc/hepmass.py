...
class HEPMASS:
    ...
    def __init__(self):
        ...
        filepath = pathlib.PureWindowsPath(r'C:\Users\tewar\Documents\work\GMCM\data\hepmass')
        trn, val, tst = load_data_no_discrete_normalised_as_array(filepath)
...
def load_data_no_discrete_normalised_as_array(path):
    ...
    data_train, data_test = data_train.to_numpy().astype('float32'), data_test.to_numpy().astype('float32')
